    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            Alert.alert('Cancel', 'Discard this address?', [
              { text: 'No' },
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            // basic validation
            if (!houseNumber || !street || !barangayName || !municipal || !province) {
            ...
            // Navigate back to addresses list where the new item will appear
            router.push('/service-provider/address');
          }}
...
const styles = StyleSheet.create({
  ...
  submitButton: {
    ...
    borderRadius: 8,
    alignItems: 'center',
    marginTop: 50, // Space above button
  },
  submitButtonText: {
    color: 'black',
    fontSize: 18,
