// Socket.IO-based chat wiring for contact_client.php
(function(){
  ...
  var bookingId = parseInt(qs('booking_id') || localStorage.getItem('last_booking_id') || '0', 10) || null;
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    // Grace period before falling back if sockets aren’t available
    setTimeout(function(){
  ...
  function enableHttpFallback(){
    ...
    // Ensure conversation exists, then poll
